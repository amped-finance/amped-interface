...
import { arbitrumReferralsGraphClient, pegasusReferralsGraphClient, phoenixReferralsGraphClient } from "lib/subgraph/clients";
...
function getGraphClient(chainId) {
  if (chainId === ARBITRUM) {
    ...
    return pegasusReferralsGraphClient;
