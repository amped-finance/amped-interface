...
import { getChainName, getConstant, IS_NETWORK_DISABLED, PHOENIX } from "config/chains";
...
function shouldSwap(collateralToken, receiveToken) {
  ...
  // @see https://github.com/Amped-Dex/amp-interface/blob/master/src/pages/Exchange/Exchange.js#L162
...
export default function PositionSeller(props) {
  ...
  const { data: hasOutdatedUi } = useHasOutdatedUi(chainId);
        ...
        return (
          <div className="Confirmation-box-warning">
            <Trans>
              ...
              <ExternalLink href="https://amped.gitbook.io/amped/trading#minimum-price-change">
                pending profit
              </ExternalLink>{" "}
              of {deltaStr}. <br />
            </Trans>
      ...
      return (
        <div className="Confirmation-box-warning">
          <Trans>
            ...
            <ExternalLink href="https://amped.gitbook.io/amped/trading#minimum-price-change">profit</ExternalLink> of{" "}
            {deltaStr}. <br />
          </Trans>
          <Trans>
            Profit price: {position.isLong ? ">" : "<"} ${formatAmount(profitPrice, USD_DECIMALS, 2, true)}. This rule
                  ...
                  renderContent={() => (
                    <div>
                      ...
                      <div className="PositionSeller-fee-item">
                        <Trans>
                          <ExternalLink href="https://amped.gitbook.io/amped/trading#fees">More Info</ExternalLink> about
                          fees.
                        </Trans>
                      </div>
                    </div>
